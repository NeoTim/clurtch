...
var APP_ROOT, ENV_GLOBALS, GLOBALS, LOCAL_IP, PUBLIC_GLOBALS_KEYS, Q, android_release_file, browserSync, cache, changed, child_process, clean, cmd, coffee, concat, connect, deploy_release_cmd, destinations, ecstatic, ejs, gulp, gutil, http, ios_deploy_release_tasks, ios_release_file, jade, k, livereload, nodemon, notify, open, open_qrcode_cmd, options, path, paths, phantomChild, phantomDefer, protractor, reload, ripple, runSequence, sass, shell, v;
...
paths = {
  ...
  scripts: {
    vendor: ["assets/components/ionic/release/js/ionic.js", "assets/components/angular/angular.js", "assets/components/lodash/dist/lodash.js", "assets/components/angular-google-maps/dist/angular-google-maps.min.js", "assets/components/angular-animate/angular-animate.js", "assets/components/angular-sanitize/angular-sanitize.js", "assets/components/gsap/src/minified/TweenMax.min.js", "assets/components/ng-Fx/dist/ngFx.min.js", "assets/components/angular-ui-router/release/angular-ui-router.js", "assets/components/restangular/dist/restangular.js", "assets/components/ionic/release/js/ionic-angular.js", "assets/components/angularjs-google-places/dist/angularjs-google-places.min.js", "assets/components/angular-classy/angular-classy.min.js", "assets/components/angular-cache/dist/angular-cache.js", "assets/components/ion-google-place/ion-google-place.js"],
    bootstrap: ['app/js/config/bootstrap.js'],
    app: ['app/js/App.js', 'app/js/*/**/*.js', 'app/js/config/app_run.js'],
    tests: ['tests/**/*.coffee']
  },
  templates: ['app/**/*.jade']
};
...
['app', 'bootstrap'].forEach(function(scriptsName) {
  return gulp.task("scripts:" + scriptsName, function() {
    return gulp.src(paths.scripts[scriptsName]).on("error", notify.onError(function(error) {
      return error.message;
...
gulp.task("build", function(cb) {
  return runSequence(["clean", "bower:install"], ["assets", "styles", "scripts", "templates"], cb);
});

gulp.task("default", function(cb) {
  return runSequence("build", ["watch", "server", "weinre", 'run:server'], function() {});
});
